...
* Pregled postojeæih korisnika preko liste
* Forma za pregled svih filmova koji su u ponudi 
* Forma za ažuriranje ponude (promjena cijena, ažuriranje liste filmova..)
* Odvojena forma za korisnika i za uposlenika (admina)
* Forma za prikaz statistike o pregledanim filmovima nakon što završe projekcije tog filma
* Rezervacija karata (online ili preko telefona)
* Popusti za odreðene skupine (studenti, Ljubitelji filma, korisnici aplikacije)
